...
const SvgAs = props => (
  <svg viewBox="0 0 512 512" width="1em" height="1em" {...props}>
    ...
    <g
      clipPath="url(#as_svg__a)"
      transform="translate(-512 -16.4) scale(1.032)"
    >
      <path fill="#006" d="M0 16h992.1v496H0z" />
      <path fill="#bd1021" fillRule="evenodd" d="M0 264l992.1 248V16L0 264z" />
      <path
        fill="#fff"
        fillRule="evenodd"
      ...
      <g stroke="#000">
        ...
        <path
          fill="none"
          strokeWidth={1.6}
          d="M724.1 254.7a4.7 4.7 0 1 1-9.3 0 4.7 4.7 0 0 1 9.3 0z"
        />
        <path
          fill="#fff"
          fillRule="evenodd"

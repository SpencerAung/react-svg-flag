...
const SvgDo = props => (
  <svg viewBox="0 0 640 480" width="1em" height="1em" {...props}>
    ...
    <g clipPath="url(#do_svg__a)" transform="matrix(.67 0 0 .67 148.7 77)">
      ...
      <path
        fill="#319400"
        d="M302 236.4l2.9 16.8h.7a21.2 21.2 0 0 0-3.6-16.8z"
      />
      ...
      <path
        fill="#428c00"
        d="M196.5 248.5l1.4 2.7-2-1.4c.6 2.7 1.3 4.4 4.1 5.4v.7l-2.8-.7 1.4 2-2-.7 6.2 6 .7-2.6 2.2 1.3-4.3-4v-.7l2.1.7a12.3 12.3 0 0 0-7-8.7z"
      />
      ...
      <path
        fill="#734a42"
        d="M265.5 248.5l-.7 15.4h.7a26.7 26.7 0 0 0 0-15.4z"
      />

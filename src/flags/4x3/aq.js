...
const SvgAq = props => (
  <svg viewBox="0 0 640 480" width="1em" height="1em" {...props}>
    ...
    <path
      ...
      strokeWidth={2.1}
      d="M574.6 284.3a3 3 0 0 0 0 2.8c1-1.3.2-1.9 0-2.8z"
    />
    <path
      fill="none"
      stroke="#fff"
      strokeLinejoin="round"
      strokeWidth={2}
      d="M203.3 167.8s-2.4-.3-1.9 1.8c.8-1.7 1.8-1.7 1.9-1.8zm.5-5c-1.3 0-3-.2-2.4 2 .8-1.7 2.4-1.9 2.4-2zm9.1 28.3s2.1-.1 1.6 2c-.8-1.6-1.5-1.9-1.6-2z"
    />
  </svg>
);

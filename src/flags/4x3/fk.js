...
const SvgFk = props => (
  <svg viewBox="0 0 640 480" width="1em" height="1em" {...props}>
    ...
    <g strokeWidth="1pt">
      <path
        fill="#fff"
        d="M0 0v25.6l317.1 203h40v-25.5L39.9 0H0zm357 0v25.6l-317 203H0v-25.5L317.1 0h40z"
      />
      <path
        fill="#fff"
        d="M148.8 0v228.6h59.5V0h-59.5zM0 76.2v76.2h357V76.2H0z"
      />
      <path
        fill="#c00"
        d="M0 91.5v45.7h357V91.5H0zM160.7 0v228.6h35.7V0h-35.7zM0 228.6l119-76.2h26.6l-119 76.2H0zM0 0l119 76.2H92.4L0 17V0zm211.4 76.2L330.4 0h26.7L238 76.2h-26.7zm145.7 152.4l-119-76.2h26.6l92.4 59.2v17z"
      />
    </g>
    <path
      fill="url(#fk_svg__b)"
      ...
      transform="matrix(1.17 0 0 1.17 -389.2 -22)"
    />
    <path
      fill="url(#fk_svg__b)"
      fillRule="evenodd"
      ...
      transform="matrix(-1.48 0 0 1.54 1073.6 -525.4)"
    />
    <path
      fill="url(#fk_svg__c)"
      fillRule="evenodd"
    ...
    <path
      ...
      strokeWidth={1.2}
      d="M445.6 595.5s5.7-8.8 10.3-8.1c4.7.6 9.1 6.2 9.4 6.5a41 41 0 0 0 6.9-7.5c-.3-.3-7.2-16.5-11-17.2s-11.8 1.2-11.8 1.8l-3.8 24.5z"
      transform="matrix(1.48 0 0 1.54 -99.8 -525.4)"
    />
    <path
      fill="url(#fk_svg__e)"
      fillRule="evenodd"
    ...
    <path
      ...
      transform="matrix(1.17 0 0 1.17 -388 -20.8)"
    />
    <path
      fill="url(#fk_svg__g)"
      fillRule="evenodd"
      ...
      transform="matrix(1.48 0 0 1.54 -98.8 -524)"
    />
    <path
      fill="url(#fk_svg__h)"
      fillRule="evenodd"
    ...
    <path
      ...
      strokeWidth={1.2}
      d="M467.8 625.5l7.2-11.9-3.6-2.5c-1 3-5.1 4-5.8 7.8s2.8 7.5 2.2 6.6z"
      transform="matrix(-1.48 0 0 1.54 1072.7 -524)"
    />
    <path
      fill="url(#fk_svg__j)"
      fillRule="evenodd"
    ...
    <path
      ...
      transform="matrix(1.48 0 0 1.54 -99.3 -521.5)"
    />
    <g fillRule="evenodd">
      <path
        fill="#bcbcbc"

  ...
  <svg viewBox="0 0 640 480" width="1em" height="1em" {...props}>
    ...
    <g fill="none" stroke="#703d29">
      ...
      <g strokeWidth={0.6}>
        ...
        <path
          strokeLinecap="round"
          d="M273.3 152l-.4-.5c-1.7-2.4-4.7-3.1-6.9-1.5-2.6 2-3.3 5.4-2.5 9a9 9 0 0 0 4 5.5"
        />
        ...
        <path
          strokeLinecap="round"
          d="M386.3 151.4a9 9 0 0 1 2.8 2.4c1.3 2 1.7 3.7 1.6 6.2-.2 4.2-3.2 7.1-6 9m-4.7-17.6l.6.7c1.9 2.2 2 5.4 1.6 7.2a8.2 8.2 0 0 1-3.8 5.4m-5-14.4c2.6 2 3.4 5.4 2.5 9-.6 2.5-2.2 4-4.2 5.2m11.1 41.1c.3 1 .9 1.3 1.5 2a13.5 13.5 0 0 0 6.2 3.5c2.4.7 4.6.2 6.3-.9m-163 54c1.2 0 2.5.9 3.3 2.3.1.2.4.8.4 1.5 0 .9-.4 1.8-1 2.2-1.5 1-4 .5-4-2"
        />
        ...
        <path
          strokeLinecap="round"
          d="M257.9 219.5a10 10 0 0 1-3.4 4.6m-9.2-17.2l2.2-.6 1.3-1 .8-1.1.7-1.8.3-1.5"
        />
      ...
      <g stroke="#c7b37f" strokeLinecap="round" strokeWidth={0.6}>
        ...
        <path strokeLinecap="butt" d="M254.2 225l-1.2.5a5.1 5.1 0 0 1-1.5.3" />
